...
class ConfingDecoder:
    ...
    def __init__(self, config_path: str):
        ...
        # Json standards usually require keys to be unique. When it does not, it appears to behave like if there is only
        # one occurrence and that is the last one. So any duplicate key (pres. name) problem is avoided.
                ...
                match slide["type"]:
                    ...
                    case "plot":
                        ...
                        if os.path.isfile(csv_path):
                            ...
                            log.error("The given file path does not exist or unreachable")
                            log.info("Skipping slide..")
                    case other:
    ...
    def __plot_slide(prs: Presentation, title_name: str, csv_path: str, config: dict):
        # In the given sample directory there was no .dat file. I researched .dat files and found that it could contain
        # anything in any kind of format. By that definition and the lack of guidelines of how the datastructure will be
        # but there were a sample.csv. I opted to use .csv files instead of .dat
